    ...
    <div className={'w-full'}>
      <div className='flex flex-row text-sm pb-1'>
        <div className='flex items-center'>
          Start: 07/08/2022 10:40 PM<BsPencil className={'mx-2'}/>
        </div>
        <div className='flex items-center ml-[2.5rem]'>
          End: 07/09/2022 12:40 PM<BsPencil className={'mx-2'}/>
        </div>
        <div className='flex items-center ml-[2.5rem]'>
      ...
      <div className='flex-1 bg-mainPrimary'>
        <div className='flex justify-between px-3 text-white text-sm'>
          <div className='flex items-center'>ECG <BsPause className={'text-xl'}/></div>
          <div className='flex items-center'>Min HR: { Math.round(liveGraph.hr.min) } pbm</div>
          <div className='flex items-center font-bold'>HR: 86 pbm</div>
          <div className='flex items-center'>Max HR: { Math.round(liveGraph.hr.max) } pbm</div>
          <div className={'flex items-center'}>
        ...
        <div id="ecgChart" ref={plotRef} className={'w-full h-[120px] outline-1 outline-black'} />
        ...
        <div className='flex justify-between items-center bg-white'>
          <div className={'flex-none items-center justify-start cursor-pointer'} onClick={handlePlay}>
            {!play ?
              <BsFillPlayFill className={'text-xl text-black'}/>
              :
              <BsPauseFill className={'text-xl text-black'}/>
            }
          </div>
